...
#include "../reaction.hh"
#include "../../../Network3_svn/include/muParser.h"
...
//		MichaelisMentenRxn();
	...
	class MuParserRxn : public BioNetGenRxn{
	public:
//		MuParserRxn();
		MuParserRxn(mu::Parser& parser, vector<SimpleSpecies*> r, vector<int> rS, vector<SimpleSpecies*> p, vector<int> pS);
		MuParserRxn(mu::Parser& parser, SimpleSpecies* r, int rS, vector<SimpleSpecies*> p, vector<int> pS);
		MuParserRxn(mu::Parser& parser, vector<SimpleSpecies*> r, vector<int> rS, SimpleSpecies* p, int pS);
		MuParserRxn(mu::Parser& parser, SimpleSpecies* r, int rS, SimpleSpecies* p, int pS);
		~MuParserRxn();
	protected:
		void construct(mu::Parser& parser);
	};
}
